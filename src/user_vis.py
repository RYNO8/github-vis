...
def ryanSync():
    ...
    print(User_info)
    print(User_repos)
    return render_template("submit.html", repos=User_repos, user_info=User_info, favLang=favLang, numRepos=len(User_repos))
...
def ronaldSync():
    ...
    return render_template("ronaldsubmit.html", pi_script=pi_script, pi_div=pi_div, contributors=contributors, total=total, owner=Owner, repo=Repo)
